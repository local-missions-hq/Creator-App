...
- [ ] Approve subscription-scoped pre-plan access, a real monitored alert destination and `$25` budget, exact subscription/identity/backend/artifact references, a saved provider-backed Terraform plan and cost review, then separately approve any apply, ephemeral deployment, cloud tests, scoped destroy, independent teardown reconciliation, live rollback, restore drill, and complete M5 evidence.
