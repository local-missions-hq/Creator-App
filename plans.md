...
- [ ] Add the cost estimate, saved-plan evidence/review, explicit apply approval, ephemeral deployment, cloud tests, scoped destroy, independent teardown reconciliation, rollback, restore drill, and complete M5 evidence.
