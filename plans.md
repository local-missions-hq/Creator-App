...
- [ ] Add the remaining reviewed AzureRM workload modules, secretless OIDC plan path, cost estimate, saved-plan review, explicit apply approval, ephemeral deployment, cloud tests, scoped destroy, independent teardown reconciliation, rollback, restore drill, and complete M5 evidence.
