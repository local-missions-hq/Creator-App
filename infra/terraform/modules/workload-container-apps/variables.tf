...
variable "allowed_ipv4_cidrs" {
  ...
  validation {
    ...
    error_message = "Container Apps API ingress requires narrow IPv4 CIDRs and forbids global ingress."
  }
}
...
variable "scale" {
  ...
  validation {
    ...
    error_message = "The disposable Container Apps contract scales API and worker from zero to one replica."
  }
}
