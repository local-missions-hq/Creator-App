# ADR-038: Local Pass uses a seven-day single-use rotating QR redemption tied to the first creator claim; V1 reports verified redemptions without claiming purchase or incremental causation
...
Local Pass uses a seven-day single-use rotating QR redemption tied to the first creator claim; V1 reports verified redemptions without claiming purchase or incremental causation
