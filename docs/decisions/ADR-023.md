# ADR-023: Multi-platform Reach reward equals one base reward plus each contracted platform's tier bonus
...
Multi-platform Reach reward equals one base reward plus each contracted platform's tier bonus
