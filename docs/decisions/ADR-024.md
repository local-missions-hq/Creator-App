# ADR-024: V1 sign-in providers are Apple, Google, Microsoft, and passwordless email; Facebook/Meta is deferred to V2
...
V1 sign-in providers are Apple, Google, Microsoft, and passwordless email; Facebook/Meta is deferred to V2
