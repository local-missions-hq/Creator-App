# ADR-005: Stripe Connect test-mode architecture and controlled live-money gate

- **Status:** Accepted — founder-approved V1 baseline
- **Decision date:** 2026-08-26
- **Source register status at freeze:** Accepted baseline 2026-08-26; live configuration gated
...
Stripe Connect test-mode architecture and controlled live-money gate
