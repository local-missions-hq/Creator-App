# ADR-027: Locality uses annual private home-ZIP proof; businesses see only an area badge and coarse distance band, never address or payment/KYC data
...
Locality uses annual private home-ZIP proof; businesses see only an area badge and coarse distance band, never address or payment/KYC data
