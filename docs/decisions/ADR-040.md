# ADR-040: A Local Pass claim reserves inventory and must be honored; businesses may pause future claims but cannot cancel active passes, and closures extend affected passes
...
A Local Pass claim reserves inventory and must be honored; businesses may pause future claims but cannot cancel active passes, and closures extend affected passes
