# ADR-026: Provider removal requires recent authentication and another verified method; total lockout uses controlled recovery with temporary financial holds
...
Provider removal requires recent authentication and another verified method; total lockout uses controlled recovery with temporary financial holds
