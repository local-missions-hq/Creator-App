# ADR-021: Campaign budget is labeled Creator Reward Pool; the platform fee and exact Total Due are displayed separately
...
Campaign budget is labeled **Creator Reward Pool**; the platform fee and exact **Total Due** are displayed separately
