# ADR-031: Businesses customize only versioned structured checklist fields within approved ranges; free text is non-enforceable, and out-of-range work requires a separately priced deliverable and admin review
...
Businesses customize only versioned structured checklist fields within approved ranges; free text is non-enforceable, and out-of-range work requires a separately priced deliverable and admin review
