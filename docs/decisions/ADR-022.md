# ADR-022: Standard platform fee is 15% and includes ordinary payment processing; no separate card-processing line
...
Standard platform fee is 15% and includes ordinary payment processing; no separate card-processing line
