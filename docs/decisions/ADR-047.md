# ADR-047: Pre-private-network Azure development is ephemeral and synthetic: use low-cost tiers, baseline firewall/TLS/RBAC controls, test and capture evidence, then destroy and verify the billable workload the same day
...
Pre-private-network Azure development is ephemeral and synthetic: use low-cost tiers, baseline firewall/TLS/RBAC controls, test and capture evidence, then destroy and verify the billable workload the same day
