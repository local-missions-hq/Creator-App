# ADR-012: Save payment method during setup; charge only after approval through Fund and Publish
...
Save payment method during setup; charge only after approval through **Fund and Publish**
