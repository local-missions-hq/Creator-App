# ADR-052: Pre-live distribution remains TestFlight-only; public App Store release waits for every live-money/production gate and a ready funded Orlando pilot, then uses manual/phased release with invite-only pilot access
...
Pre-live distribution remains TestFlight-only; public App Store release waits for every live-money/production gate and a ready funded Orlando pilot, then uses manual/phased release with invite-only pilot access
