# ADR-055: Creator/business waitlist entries require annual reconfirmation, withdraw/expire out of selection immediately, delete role-specific data within 30 days, and retain only a non-personal deletion/fairness audit for 12 additional months
...
Creator/business waitlist entries require annual reconfirmation, withdraw/expire out of selection immediately, delete role-specific data within 30 days, and retain only a non-personal deletion/fairness audit for 12 additional months
