# ADR-045: Platform-wide admin, support, trust/safety, and finance work remains in a protected employee web console; the shared iPhone app contains only Creator, Business, and restricted Venue Staff modes
...
Platform-wide admin, support, trust/safety, and finance work remains in a protected employee web console; the shared iPhone app contains only Creator, Business, and restricted Venue Staff modes
