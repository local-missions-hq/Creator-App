# ADR-018: Reach rewards use fixed +50%, +100%, or +200% creator bonuses; the standard platform percentage applies transparently to the total
...
Reach rewards use fixed +50%, +100%, or +200% creator bonuses; the standard platform percentage applies transparently to the total
