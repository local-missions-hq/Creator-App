# ADR-013: Creator rewards are all-or-nothing per slot; incomplete or canceled work earns no partial reward
...
Creator rewards are all-or-nothing per slot; incomplete or canceled work earns no partial reward
