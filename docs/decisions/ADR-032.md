# ADR-032: V1 template defaults and limits use 5 photos/2 clips for Visit & Create, one disclosed single-platform post for Visit & Share, 60-minute attendance plus 3 photos/2 clips for Event Attendance, and a 10-question/10-minute ceiling for Private Feedback
...
V1 template defaults and limits use 5 photos/2 clips for Visit & Create, one disclosed single-platform post for Visit & Share, 60-minute attendance plus 3 photos/2 clips for Event Attendance, and a 10-question/10-minute ceiling for Private Feedback
