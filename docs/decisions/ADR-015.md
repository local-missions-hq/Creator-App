# ADR-015: A no-payout slot automatically returns its reward and allocated fees to the original payment; Local Missions absorbs unrecoverable processing cost
...
A no-payout slot automatically returns its reward and allocated fees to the original payment; Local Missions absorbs unrecoverable processing cost
