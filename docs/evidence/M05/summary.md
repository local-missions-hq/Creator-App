...
Status: M5.5 owner-directed Azure cost pause; local retained-state recovery gate and bootstrap saved-plan reviewer ready; no workload deployed and remote Terraform state intentionally offline
